...
require (
	...
	github.com/anchore/grype v0.79.4-0.20240730155004-ba4d413087a1
...
require (
	...
	github.com/testcontainers/testcontainers-go/modules/registry v0.34.0 // indirect
	...
	oras.land/oras v1.2.0 // indirect
